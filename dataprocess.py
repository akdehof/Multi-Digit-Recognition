...
class ExampleReader(object):  
    ...
    def read_and_convert(self, digit_struct_mat_file):  
          ...
          attrs = ExampleReader._get_attrs(digit_struct_mat_file, index)  # num_digits=8
          label_of_digits = attrs['label']  
          length = len(label_of_digits)  
          if length > 5:   # TODO ANNE 5-->8 bzw ExampleReader.num_digits
              # skip this example  
              return self.read_and_convert(digit_struct_mat_file)  
    
          digits = [10, 10, 10, 10, 10]   # digit 10 represents no digit  # TODO ANNE [10]*num_digits
...
path_to_train_dir =  os.path.join(path_to_data_dir , '/data/train')
path_to_test_dir =   os.path.join(path_to_data_dir , '/data/test')
path_to_extra_dir =  os.path.join(path_to_data_dir , '/data/extra')
path_to_train_digit_struct_mat_file =  os.path.join(path_to_data_dir,  '/data/train/digitStruct.mat')
path_to_test_digit_struct_mat_file =   os.path.join(path_to_data_dir , '/data/test/digitStruct.mat')
path_to_extra_digit_struct_mat_file =  os.path.join(path_to_data_dir , '/data/extra/digitStruct.mat')
